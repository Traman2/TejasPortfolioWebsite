            ...
            <div className="w-screen h-screen bg-background flex flex-col cursor-main">
                ...
                <div className="flex-1 flex border-y-2 border-dashed border-primary">
                    ...
                    <div className="flex-1 mx-12 ">
                        ...
                        <div className="px-40 py-15 flex flex-col gap-6 items-center justify-center h-full">
                            <p className="text-5xl font-footer font-bold">404 Not Found</p>
                            <p className="text-gray-500 text-sm font-footer">Please check the URL and try again</p>
                        </div>
                    </div>
