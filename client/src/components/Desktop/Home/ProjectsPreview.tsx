      ...
      <div className="mt-2 rounded-xl bg-[#1D1C22] px-12 py-6 text-lg">
        ...
        <div className="flex justify-center mt-6 ">
          <button
            ...
            className="cursor-pointer bg-[#6DED97] px-6 py-2 shadow-lg text-sm rounded-3xl font-bold transition-transform duration-200 hover:bg-[#4ec87a] hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#6DED97]/50"
          >
            Click to view more
          </button>
        </div>
