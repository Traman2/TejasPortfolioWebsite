...
export default function MobileSkills() {
    return (
        <div className="bg-[#1D1C22] rounded-lg mt-3 p-5">
            ...
            <p className="text-[#CDD2D3] text-xs mb-4">
            ...
            <div className="space-y-3">
                <div className="flex items-center flex-wrap mb-1">
                    <span className="text-white font-bold mr-2 text-xs">Programming Languages:</span>
                ...
                <div className="flex items-center flex-wrap mb-1">
                    <span className="text-white font-bold mr-2 text-xs">Frontend:</span>
                ...
                <div className="flex items-center flex-wrap mb-1">
                    <span className="text-white font-bold mr-2 text-xs">Backend:</span>
                ...
                <div className="flex items-center flex-wrap mb-1">
                    <span className="text-white font-bold mr-2 text-xs">AI and ML Frameworks:</span>
                ...
                <div className="flex items-center flex-wrap mb-1">
                    <span className="text-white font-bold mr-2 text-xs">Tools:</span>
            ...
            <p className="text-[#CDD2D3] text-xs mt-5">
            ...
            <div className="mt-6 flex justify-center">
                <button
                    className="flex items-center gap-2 py-1 px-4 bg-[#6DED97] rounded-2xl text-xs font-semibold text-black shadow font-bold transition-transform transition-colors duration-200 hover:bg-[#4ec87a] hover:scale-105 focus:outline-none"
                >
